...
pub const BASE_SUGARS: &[(&str, BaseSugar, &[GlycanSubstituent])] = &[
    ("sug", BaseSugar::Sugar, &[]),
...
pub const POSTFIX_SUBSTITUENTS: &[(&str, GlycanSubstituent)] = &[
...
pub const DOUBLE_LINKED_POSTFIX_SUBSTITUENTS: &[(&str, &[GlycanSubstituent])] = &[
...
pub const PREFIX_SUBSTITUENTS: &[(&str, GlycanSubstituent)] = &[
...
pub static GLYCAN_PARSE_LIST: LazyLock<Vec<(String, MonoSaccharide)>> = LazyLock::new(|| {
    vec![
        (
            "phosphate".to_string(),
            MonoSaccharide {
