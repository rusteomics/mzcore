...
use crate::{
    ...
    sequence::{
        CompoundPeptidoformIon, Modification, Peptidoform, PlacementRule, Position, SemiAmbiguous,
...
format_family!(
    ...
    required {
        ...
        mass_error: Mass, |location: Location, _| location.parse::<f64>(NUMBER_ERROR).map(Mass::new::<crate::system::mass::dalton>);
