...
impl_metadata!(
    formats: {BasicCSV,DeepNovoFamily,Fasta,MaxQuant,InstaNovo,MZTab,NovoB,Novor,Opair,Peaks,PepNet,PiHelixNovo,PLGS,PLink,PowerNovo,Proteoscape,Sage,MSFragger,SpectrumSequenceList};
    functions: {
