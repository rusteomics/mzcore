...
pub enum MassMode {
    ...
    #[default]
    Monoisotopic,
    /// The average weight, the average between all occurring isotopes (eg something in between 12C
    /// and 13C depending on the number of C)
    Average,
    #[cfg(feature = "isotopes")]
    /// The most abundant mass, the most abundant single isotopic species (eg 12C or 13C depending
    /// on the number of C).
    ///
